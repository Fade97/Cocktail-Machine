========================================================================
    KONSOLENANWENDUNG: Cocktail Machine-Projektübersicht
========================================================================

Diese Cocktail Machine-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Cocktail Machine-Anwendung besteht.


Cocktail Machine.vcxproj
...
Cocktail Machine.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Cocktail Machine.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
